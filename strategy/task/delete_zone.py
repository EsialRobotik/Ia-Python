...
class DeleteZone(AbstractTask):
    ...
    def execute(self, start_point: Position):
        ...
        self.path_finding.update_dynamic_zone(self.item_id, False)
        return {
            "task": self.desc,
            "command": f"delete-zone#{self.item_id}",
