...
class ActionAX12ComplianceSlope(AbstractAction):
    """
    ...
    def __init__(self, ax12: AX12Servo, value: int) -> None:
        ...
        :param value: The value of the compliance slope.
        """
        self.ax12 = ax12
        self.executed = False
        self.value = value
    ...
    def execute(self) -> None:
        ...
        :param ax12: The AX12 instance to disable torque on.
        """
        self.ax12.set_cw_compliance_slope(self.value)
        self.ax12.set_ccw_compliance_slope(self.value)
        self.executed = True
        pass
