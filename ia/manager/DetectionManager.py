...
from ia.api.detection.ultrasound import Srf
from ia.asserv import Asserv, MovementDirection
from ia.utils import Position


class DetectionManager:
    def __init__(self, sensors: list[Srf], lidar: Lidar, asserv: Asserv, table_config: Dict) -> None:
        """
        ...
        Args:
            ...
            the robot.
            lidar (Lidar): An instance of the Lidar class.
