...
class Asserv:
    ...
    Attributes:
        ...
        asserv_status (AsservStatus): The current status of the robot.
    ...
    def __init__(self, serialPort: str, baudRate: int, gostart_config):
        ...
        Attributes:
            ...
            asserv_status (AsservStatus): The current status of the asserv (initially STATUS_IDLE).
    ...
    def parse_asserv_position(self):
        ...
        - asserv_status: integer representing the status of the asserv system.
        ...
        Args:
            str (str): The input string containing the asserv position data.
        Raises:
    ...
    def wait_for_asserv(self):
        ...
        and waits until the queue is empty and the asserv status is idle. It 
