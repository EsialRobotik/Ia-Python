...
from ia.api.ax12.enums import ax12_register, ax12_instr
from ia.api.ax12.enums.ax12_address import AX12Address
from ia.api.ax12.enums.ax12_error import AX12Error
from ia.api.ax12.enums.ax12_instr import AX12Instr
from ia.api.ax12.enums.ax12_register import AX12Register
...
class AX12Servo:
    ...
    Attributes:
        ...
        serial_link (ax12_link_serial): The serial link used for communication with the servomotor.
    ...
    def __init__(self, address: int, serial_link: AX12LinkSerial) -> None:
        ...
        Args:
            address (int): The address of the AX12 servomotor.
            serialLink (ax12_link_serial): The serial link used for communication with the servomotor.
        """
    ...
    def write(self, register: AX12Register, value: int) -> None:
        ...
        Args:
            register (ax12_register): The register to write to.
    ...
    def send_request(self, instruction: AX12Instr, params: bytearray) -> bytearray:
        ...
        Args:
            instruction (ax12_instr): The instruction to send to the AX12 device.
    ...
    def validate_packet(packet: bytearray, ax12_addr: int) -> (str | None):
        ...
        if packet[0] != packet[1] or packet[0] != AX12Servo.int_to_unsigned_byte(0xFF)[0]:
    ...
    def read(self, register: AX12Register) -> int:
        ...
        Args:
            register (ax12_register): The register from which to read data. The register object should contain
