...
function Luafinding:Initialize( startX, startY, finishX, finishY, positionOpenCheck )
    local newPath = setmetatable( { Start = Vector(startX, startY), Finish = Vector(finishX, finishY), PositionOpenCheck = positionOpenCheck }, Luafinding )
